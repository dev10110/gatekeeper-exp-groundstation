...
class MPCPlanner(Node):
    ...
    def goal_callback(self, msg):
        self.get_logger().info("got goal callback")
    ...
    def state_callback(self, msg):
        ...
        self.state_callback_timestamp = self.get_clock().now()
    ...
    def publish_trajectory(self):
        ...
        di_msg.header.stamp = self.state_callback_timestamp.to_msg()
